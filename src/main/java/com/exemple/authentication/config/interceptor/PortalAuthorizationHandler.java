...
import com.exemple.authentication.service.impl.PortalUserDetailsServiceImpl;
...
public class PortalAuthorizationHandler extends HandlerInterceptorAdapter {

    @Autowired
    private PortalUserDetailsServiceImpl userDetailsService;
    ...
    private boolean shouldNotFilter(HttpServletRequest request, Object handlerMethod) {
        ...
        return new AntPathMatcher().match("/api/v1/portal/login", request.getRequestURI());
    }
